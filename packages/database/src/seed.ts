    ...
    data: [
      {
        organizationId: org.id,
        customerId: abcStores.id,
        eventType: BusinessEventType.INVOICE_OVERDUE,
        summary: 'Invoice INV-102 (₦500,000) became overdue (21 days past due date)',
        payload: { invoiceId: invABC1.id, amount: 500000 },
      ...
      },
      {
        ...
        summary: 'ABC Stores missed promised payment of ₦300,000 scheduled for Friday',
        payload: { commitmentId: commABC.id, amount: 300000 },
        createdAt: daysAgo(3),
      },
      {
        organizationId: org.id,
        ...
        summary: 'Musa Enterprises promised payment of ₦450,000 by tomorrow',
        payload: { amount: 450000, promisedDate: daysAhead(1) },
        createdAt: daysAgo(2),
      },
    ],
  });
